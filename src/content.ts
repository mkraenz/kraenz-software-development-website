  ...
  services: {
    ...
    technologies: {
      ...
      techs2: [
        {
          name: "TypeScript",
          tags: ["frontend", "backend", "other"],
        },
        { name: "JavaScript", tags: ["frontend", "backend", "other"] },
        ...
        { name: "AWS S3", tags: ["frontend", "backend", "devops"] },
        { name: "AWS RDS", tags: ["backend", "devops"] },
        { name: "AWS EC2", tags: ["devops"] },
        { name: "AWS App Runner", tags: ["devops"] },
        { name: "AWS CloudWatch", tags: ["backend", "devops"] },
        ...
        {
          name: "Nx Mono repo",
          tags: ["frontend", "backend", "devops", "other"],
        },
        { name: "Netlify", tags: ["frontend", "devops"] },
        { name: "Auth0", tags: ["frontend", "backend", "devops", "3rdparty"] },
        { name: "JWT", tags: ["frontend", "backend"] },
        { name: "OAuth2.0", tags: ["frontend", "backend"] },
        { name: "OpenID Connect OIDC", tags: ["frontend", "backend"] },
        { name: "Passport.js", tags: ["backend"] },
        { name: "Domain-Driven Design", tags: ["backend", "other"] },
        { name: "Event Sourcing", tags: ["backend", "other"] },
        {
          name: "Command Query Responsibility Segregation CQRS",
          tags: ["backend", "other"],
        },
        { name: "Event-Driven Architecture", tags: ["backend", "other"] },
        { name: "GraphQL", tags: ["frontend", "backend"] },
        { name: "REST API", tags: ["frontend", "backend"] },
        { name: "Cypress", tags: ["frontend", "other"] },
        { name: "Playwright", tags: ["frontend", "other"] },
        { name: "Jest", tags: ["frontend", "backend", "other"] },
        { name: "Chai & Mocha", tags: ["frontend", "backend", "other"] },
